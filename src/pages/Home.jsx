    ...
    <div className="sm:max-w-[810px] max-w-[350px] mx-auto sm:mt-[70px] mt-[20px]">
      ...
      <div className="border-[1px] border-[#27272a] w-[full] sm:h-[205px] p-[20px] rounded-[10px]">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="font-[Menlo] sm:text-[36px] text-[20px] leading-[40px] font-[700] tracking-tighter">
              Shashi Ranjan Singh
            </h1>
          </div>
          <div className="flex items-center gap-3">
            <a
              href="mailto:prathamjii36@gmail.com"
              className="p-[10px] border-[1px] border-[#27272a] w-[41.6px] h-[41.6px] rounded-[10px] cursor-pointer"
            >
              <svg
            ...
            <a
              href="https://github.com/PrathamSingh1"
              className="p-[10px] border-[1px] border-[#27272a] w-[41.6px] h-[41.6px] rounded-[10px] cursor-pointer"
            >
              <svg
                className="hover:scale-125 transition-transform duration-300"
            ...
            <a
              href="https://www.linkedin.com/in/shashi-ranjan-singh-b94b7524a/"
              className="p-[10px] border-[1px] border-[#27272a] w-[41.6px] h-[41.6px] rounded-[10px] cursor-pointer"
            >
              <svg
                className="hover:scale-125 transition-transform duration-300"
        ...
        <div className="sm:text-[20px] text-[18px] font-[400] leading-[26px] mt-[15px]">
          <p>
            ...
            applications with clean code, modern technologies, and seamless user
            experiences.
          </p>
        </div>
      </div>
      ...
      <div>
        <h1 className="sm:text-[40px] text-[32px] text-[#f1f5f9] leading-[52px] font-[700] mb-[30px] mt-[55px]">
          What I work with
        </h1>
        <div className="whitespace-nowrap overflow-hidden">
          <div className="flex w-max frontendContainer">
            <div className="flex items-center sm:gap-3 gap-2 sm:text-[20px] text-[16px] p-[8px]">
              ...
              <i className="devicon-tailwindcss-plain sm:text-3xl text-2xl"></i>{" "}
              Tailwind
              <i className="devicon-bootstrap-plain sm:text-3xl text-2xl"></i>{" "}
              Bootstrap
              <i className="devicon-materialui-plain sm:text-3xl text-2xl"></i>{" "}
              MaterialUI
              <i className="devicon-sass-plain sm:text-3xl text-2xl"></i> Sass
              <i className="devicon-javascript-plain sm:text-3xl text-2xl"></i>{" "}
              JavaScript
              <i className="devicon-typescript-plain sm:text-3xl text-2xl"></i>{" "}
              TypeScript
              <i className="devicon-react-plain sm:text-3xl text-2xl"></i> React
              <i className="devicon-nextjs-plain sm:text-3xl text-2xl"></i>{" "}
              Nextjs
            </div>
          ...
          <div className="flex w-max backendContainer">
            <div className="flex items-center sm:gap-3 gap-2 sm:text-[20px] text-[16px] p-[8px] mt-[10px]">
              <i class="devicon-nodejs-plain-wordmark sm:text-3xl text-2xl"></i>{" "}
              Node.js
              <i class="devicon-express-original sm:text-3xl text-2xl"></i>{" "}
              Express
              <i class="devicon-mongodb-plain sm:text-3xl text-2xl"></i> MongoDB
              <i class="devicon-mysql-original sm:text-3xl text-2xl"></i> MySQL
              <i class="devicon-postgresql-plain sm:text-3xl text-2xl"></i>{" "}
              PostgreSQL
              <i class="devicon-prisma-original sm:text-3xl text-2xl"></i>{" "}
              Prisma
              <i class="devicon-git-plain sm:text-3xl text-2xl"></i> Git
              <i class="devicon-github-original sm:text-3xl text-2xl"></i>{" "}
              Github
              <i class="devicon-docker-plain sm:text-3xl text-2xl"></i> Docker
              <i class="devicon-amazonwebservices-plain-wordmark sm:text-3xl text-2xl"></i>{" "}
              AWS
              <i class="devicon-cloudflare-plain sm:text-3xl text-2xl"></i>{" "}
              Cloudflare
              <i class="devicon-vercel-original sm:text-3xl text-2xl"></i>{" "}
              Vercel
      ...
      <div className="sm:max-w-[800px] max-w-[350px] mx-auto mt-10">
        <h1 className="sm:text-[40px] text-[32px] leading-[52px] font-[700] mb-[30px] mt-[30px]">
          Projects
        </h1>
        {/* PayTM */}
        {/* <div className="group relative w-full h-full mb-5 [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] opacity-90 overflow-hidden">
          <img
            src="/Paytm.png"
            className="w-full h-full transition-all duration-300 ease-out opacity-70 overflow-hidden [mask-image:linear-gradient(to_top,transparent_15%,#000_100%)] hover:opacity-100 group-hover:scale-105 object-cover"
            alt="PayTM"
          />
          <div className="absolute bottom-0 left-0 group-hover:-translate-y-6 z-10 flex flex-col gap-1 p-6 transition-all duration-300 custom">
            <h2 className="text-xl font-semibold text-neutral-700 dark:text-neutral-300 m-0">
              PayTM
            </h2>
            <div className="flex gap-2 mt-1 flex-wrap"></div>
            <p className="max-w-lg text-neutral-400 m-0">
              Website where you can transfer your wallet amount to other
              account.
            </p>
        ...
        <div className="group relative w-full h-full mb-5 [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] opacity-100 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 group-hover:-translate-y-6 z-10 flex flex-col gap-1 p-6 transition-all duration-300 custom">
            ...
            <p className="max-w-lg text-neutral-400 m-0">
              A Web Based Operating System where you can browse chrome, terminal
              and many more.
            </p>
            {/* Live link */}
            <a
        ...
        <div className="group relative w-full h-full mb-5 [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] opacity-100 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 group-hover:-translate-y-6 z-10 flex flex-col gap-1 p-6 transition-all duration-300 custom">
            <h2 className="text-xl font-semibold text-neutral-700 dark:text-neutral-300 m-0">
              Refokus Website Design
            </h2>
            {/* Tech stack */}
            <div className="flex gap-2 mt-1 flex-wrap">{/* stack here */}</div>
            <p className="max-w-lg text-neutral-400 m-0">
              Build A Cool Animated Website Of Refokus.
            </p>
            {/* Live link */}
            <a
        ...
        <div className="group relative w-full h-full mb-5 [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] opacity-100 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 group-hover:-translate-y-6 z-10 flex flex-col gap-1 p-6 transition-all duration-300 custom">
            ...
            <div className="flex gap-2 mt-1 flex-wrap">{/* stack here */}</div>
            <p className="max-w-lg text-neutral-400 m-0">
              Website where you can share your thoughts with everyone.
            </p>
            {/* Live link */}
            <a
